...
import com.springdev.hibernate.demo.entity.Review;
...
public class CreateCourseAndStudentsDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// create the students
			Student tempStudent1 = new Student("John", "Snow", "jsnow@gmail.com");
			Student tempStudent2 = new Student("Cersei", "Lannister", "clannister@gmail.com");
